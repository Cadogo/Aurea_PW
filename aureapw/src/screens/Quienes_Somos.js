...
import Viabilidad_tecnica from '../assets/img/Viabilidad_tecnica.jpg';
...
const Quienes_Somos = () => {
    ...
    return (
        <div>
            <body>
                {/* <section id='contenedorCentrar'>
                    <article id='contenedorTituloViabilidad'>
                        <h1>Viabilidad</h1>
                    </article>
                    <article id='contenedorTextoViabilidad'>
                        <img id='imgViabilidad' src={Viabilidad_economica}></img>
                        <div id='textoViabilidad'>
                            <h2 className='letraViabilidad'>VIABILIDAD ECONÓMICA</h2>
                            <p className='letraViabilidad'>• La viabilidad económica del proyecto es su fuerte, ya que la aplicación con su desarrollo completado se podría adaptar a otras fábricas y ayudar a las industrias a llegar a la cuarta revolución industrial. La cuarta revolución industrial se basa en una evolución de las fábricas para adaptarse al big data y la interconexión a gran escala de sistemas y dispositivos.</p>
                            <p className='letraViabilidad'>• Dentro de poco una fábrica sin esos avances tecnológicos estará obsoleta. Al tener que estar conectadas la aplicación es una forma sencilla en la que recibir e interpretar los datos de la fábrica.</p>
                            <p className='letraViabilidad'>• Además la aplicación nace en el eje del mediterraneo una de las cinco zonas más importantes para España en cuanto a industria se refiere. Lo que hace que la aplicación tenga mucha clientela potencial. Un servicio parecido como Grafana cuesta 50 euros más uso para uso personal y se requiere contactar para saber el costo de grafana para una empresa. Otras aplicaciones parecidas cuestan desde 1000 hasta 1600 euros.</p>
                            <p className='letraViabilidad'>• Por lo tanto deja una oportunidad de mercado a Aurea ya que se pueden reducir mucho los costes. También hay que tener en cuenta la inversión que aunque no se requiere una gran cantidad hace falta para los servicios remotos como servidores.</p>
                        </div>
                    </article>
                    <article id='contenedorTextoViabilidad'>
